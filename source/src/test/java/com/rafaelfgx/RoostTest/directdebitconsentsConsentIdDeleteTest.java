...
public class directdebitconsentsConsentIdDeleteTest {
	...
	public void setUp() {
		...
		envList = dataloader.load(
				"src\\test\\java\\com\\rafaelfgx\\RoostTest\\direct-debit-consents_consentIdDeleteTest.csv",
				envVarsList);
	}
          ...
          RestAssured.baseURI = (testData.get("BASE_URL") != null && !testData.get("BASE_URL").isEmpty()) ? testData.get("BASE_URL"): "https://hsbcdeveloperportalpreprod.digitalapicraft.com:8085/https://sandbox.ob.business.hsbc.com.hk/mock/open-banking/v1.0/direct-debit";
              ...
              if (testData.get("statusCode") != null) {
                ...
                equalTo(Integer.toString(Integer.parseInt(testData.get("statusCode")))));
                 ...
                 List<String> expectedStatusCodes = Arrays.asList("204","400","401","403","405","406","429","503","504","5XX");
          ...
          case "5XX":
           ...
           break;
              ...
              if (contentType.contains("application/xml") || contentType.contains("text/xml")) {
                ...
                if (Integer.toString(responseObj.statusCode()) == "204") {
