...
public class AwsConfiguration {
	...
	private AwsCredentials credentials() {
		return AwsBasicCredentials.create(environment.getProperty("spring.cloud.aws.credentials.access-key"),
				environment.getProperty("spring.cloud.aws.credentials.secret-key"));
	}

	private SqsAsyncClient buildSqsAsyncClient() {
		final var client = SqsAsyncClient.builder()
			.region(region())
