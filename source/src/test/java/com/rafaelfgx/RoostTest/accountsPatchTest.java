...
public class accountsPatchTest {
	...
	public void setUp() {
		...
		String[] envVarsList = { "" };
		envList = dataloader.load("src\\test\\java\\com\\rafaelfgx\\RoostTest\\accountsPatchTest.csv", envVarsList);
	}
	...
	public void accountsPatch_Test() throws JSONException {
		...
		for (Map<String, String> testData : envList) {
			...
			if (testData.get("statusCode") != null) {
				...
				List<String> expectedStatusCodes = Arrays.asList("200", "4XX");
