...
public class accountsPostTest {
	...
	public void setUp() {
		...
		String[] envVarsList = { "" };
		envList = dataloader.load("src\\test\\java\\com\\rafaelfgx\\RoostTest\\accountsPostTest.csv", envVarsList);
	}
	...
	public void accountsPost_Test() throws JSONException {
		...
		for (Map<String, String> testData : envList) {
			...
			if (testData.get("statusCode") != null) {
				...
				List<String> expectedStatusCodes = Arrays.asList("201", "4XX");
			...
			if (Integer.toString(responseObj.statusCode()) == "4XX") {
