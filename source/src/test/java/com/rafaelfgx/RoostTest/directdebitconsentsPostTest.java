...
public class directdebitconsentsPostTest {
	...
	public void setUp() {
		...
		envList = dataloader.load("src\\test\\java\\com\\rafaelfgx\\RoostTest\\direct-debit-consentsPostTest.csv",
				envVarsList);
	}
          ...
          RestAssured.baseURI = (testData.get("BASE_URL") != null && !testData.get("BASE_URL").isEmpty()) ? testData.get("BASE_URL"): "https://hsbcdeveloperportalpreprod.digitalapicraft.com:8085/https://sandbox.ob.business.hsbc.com.hk/mock/open-banking/v1.0/direct-debit";
              ...
              if (testData.get("statusCode") != null) {
                ...
                equalTo(Integer.toString(Integer.parseInt(testData.get("statusCode")))));
                 ...
                 List<String> expectedStatusCodes = Arrays.asList("201","400","401","403","405","406","415","429","503","504","5XX");
              MatcherAssert.assertThat(Integer.toString(responseObj.statusCode()), is(in(expectedStatusCodes)));
                 }

        switch(Integer.toString(responseObj.statusCode())){
          ...
          case "5XX":
           ...
           break;
              ...
              if (contentType.contains("application/xml") || contentType.contains("text/xml")) {
                ...
                if (Integer.toString(responseObj.statusCode()) == "201") {
...
if (Integer.toString(responseObj.statusCode()) == "400") {
              ...
              if (response.get("errors["+ i +"].causes") != null) {
                ...
                MatcherAssert.assertThat(response.getString("errors["+ i +"].causes").length(), lessThanOrEqualTo(5XX));
              ...
              if (response.get("errors["+ i +"].extendedDetails.path") != null) {
                ...
                MatcherAssert.assertThat(response.getString("errors["+ i +"].extendedDetails.path").length(), lessThanOrEqualTo(5XX));
...
if (Integer.toString(responseObj.statusCode()) == "401") {
					System.out.println("Description: Unauthorised");
				}
if (Integer.toString(responseObj.statusCode()) == "403") {
					System.out.println("Description: Forbidden");
				}
if (Integer.toString(responseObj.statusCode()) == "405") {
...
if (Integer.toString(responseObj.statusCode()) == "406") {
...
if (Integer.toString(responseObj.statusCode()) == "415") {
...
if (Integer.toString(responseObj.statusCode()) == "429") {
...
if (Integer.toString(responseObj.statusCode()) == "503") {
...
if (Integer.toString(responseObj.statusCode()) == "504") {
...
if (Integer.toString(responseObj.statusCode()) == "5XX") {
