...
public class Data {
	...
	public static final User user = new User(UUID.fromString(id), "User", "user@mail.com", "user", passwordEncoded,
			authorities);

	public static final User userUpdate = new User(UUID.fromString(id), "User Update", "user.update@mail.com", "user",
			passwordEncoded, authorities);

	public static final User userConflict = new User(UUID.randomUUID(), "User Conflict", "user@mail.com", "user",
			passwordEncoded, authorities);

	public static final Product product = new Product(UUID.fromString(id), "Product", BigDecimal.valueOf(100L));

	public static final Product productUpdate = new Product(UUID.fromString(id), "Product Update",
